...
function createGalleryCard(item) {
  ...
  const tags = item.tags
    .map(
      (tag) =>
        `<span class="rounded-tag${item.captionClass ? " " + item.captionClass : ""}">${tag}</span>`,
    )
    .join("");
...
function renderGalleryData(data, containerId) {
  ...
  if (!container) return;
  container.innerHTML = data.map((item) => createGalleryCard(item)).join("");
}
...
function renderTextData(siteData) {
  ...
  document.getElementById("avatar-image").alt =
    `${siteData.avatar.name} avatar`;
  ...
  document.getElementById("avatar-button-text").textContent =
    siteData.avatar.buttonText;

  document.getElementById("headline-title").textContent =
    siteData.intro.headline;
  document.getElementById("download-cv-btn").href =
    siteData.intro.downloadCvHref;
  document.getElementById("download-cv-text").textContent =
    siteData.intro.downloadCvText;

  document.getElementById("portfolio-subtitle").textContent =
    siteData.portfolioSection.subtitle;
  document.getElementById("portfolio-title").textContent =
    siteData.portfolioSection.title;

  document.getElementById("physical-products-title").textContent =
    siteData.physicalSection.title;
  document.getElementById("physical-products-description").innerHTML =
    siteData.physicalSection.description;

  document.getElementById("about-subtitle").textContent =
    siteData.aboutSection.subtitle;
  document.getElementById("about-title").textContent =
    siteData.aboutSection.title;
  document.getElementById("about-text").textContent =
    siteData.aboutSection.text;
  document.getElementById("download-cv-button").href =
    siteData.aboutSection.downloadCvHref;
  document.getElementById("download-cv-button-text").textContent =
    siteData.aboutSection.downloadCvText;

  document.getElementById("resume-subtitle").textContent =
    siteData.resumeSection.subtitle;
  document.getElementById("resume-title").textContent =
    siteData.resumeSection.title;
  document.getElementById("work-title").textContent =
    siteData.resumeSection.workTitle;
  document.getElementById("education-title").textContent =
    siteData.resumeSection.educationTitle;
  document.getElementById("tools-title").textContent =
    siteData.resumeSection.toolsTitle;
  document.getElementById("contact-subtitle").textContent =
    siteData.contactSection.subtitle;
